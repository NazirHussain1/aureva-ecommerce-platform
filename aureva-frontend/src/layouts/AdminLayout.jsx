...
export default function AdminLayout() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center space-x-3 pl-4 border-l border-gray-200">
                ...
                <button
                  ...
                  className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 transition text-sm font-medium flex items-center space-x-2"
                >
      ...
      <div className="flex">
        <aside className={`${sidebarOpen ? 'w-64' : 'w-0 lg:w-20'} bg-white shadow-lg transition-all duration-300 overflow-hidden`}>
          <nav className="p-4">
